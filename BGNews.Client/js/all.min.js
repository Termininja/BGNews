...
!function(){"use strict";newsApp.controller("PageController",function(e,r,t,s,c,o,n,a){c.navigateTo=function(e){r.path(e),c.$apply()},c.reloadTo=function(e){t.location.assign(e)},c.login=function(e){Parse.User.logIn(e.username,e.password,{success:function(){c.statusUpdate(),c.reloadTo("/")},error:function(e,r){console.log("Error: "+r.code+" "+r.message)}})},c.signup=function(e){var r="2IPQes1NcD",t=new Parse.User;t.set("username",e.username),t.set("password",e.password),t.set("email",e.email),t.set("colorScheme","Black"),t.set("role",{__type:"Pointer",className:"_Role",objectId:r}),t.signUp(null,{success:function(){c.reloadTo("/profile")},error:function(e,r){console.log("Error: "+r.code+" "+r.message)}})},c.logout=function(){Parse.User.logOut(),c.statusUpdate(),c.reloadTo("/")},c.profileImageUpdate=function(){c.currentUser.showImage&&c.currentUser.showImage!=c.currentUser.image?c.currentUser.showImage=c.currentUser.image:c.currentUser.image?c.currentUser.showImage=c.currentUser.image.url():c.currentUser.showImage=a},c.statusUpdate=function(){c.currentUser=Parse.User.current(),c.currentUser?n.getUserRole().then(function(e){c.currentUser.role=e,c.currentUser.username=c.currentUser.get("username"),c.currentUser.email=c.currentUser.get("email"),c.currentUser.firstName=c.currentUser.get("firstName"),c.currentUser.lastName=c.currentUser.get("lastName"),c.currentUser.website=c.currentUser.get("website"),c.currentUser.gender=c.currentUser.get("gender"),c.currentUser.aboutMe=c.currentUser.get("aboutMe"),c.currentUser.colorScheme=c.currentUser.get("colorScheme"),c.currentUser.image=c.currentUser.get("image"),c.profileImageUpdate(),c.colorSchemeUpdate()}):c.colorSchemeUpdate()},c.colorSchemeUpdate=function(){switch(c.csLeftArrow="cs-left-arrow-white",c.csRightArrow="cs-right-arrow-white",c.currentUser?c.currentUser.colorScheme:void 0){default:c.csHtml="cs-html-black";break;case"Brown":c.csHtml="cs-html-brown";break;case"Gray":c.csHtml="cs-html-gray",c.csLeftArrow="cs-left-arrow-black",c.csRightArrow="cs-right-arrow-black";break;case"Red":c.csHtml="cs-html-red";break;case"Turquoise":c.csHtml="cs-html-turquoise"}},c.getPostsInFooter=function(){o.getRecentPosts(5).then(function(e){c.recentPosts=e}),o.getRecentComments(5).then(function(e){c.recentComments=e}),o.getPopularPosts(5).then(function(e){c.popularPosts=e})},c.statusUpdate(),c.getPostsInFooter()})}();
!function(){"use strict";newsApp.controller("PostController",function(t,o,e,n){t.replyToPost=!0,t.tabPostsShow=[!0,!1,!1],t.getAllComments=function(){n.getComments(o.postId).then(function(o){t.comments=o})},t.replyTo=function(o){function e(t){$.map(t.comments,function(t){t.showReply=t.id===o,e(t)})}t.replyToCommentId=o,t.replyToPost=!1,e(t)},t.addComment=function(e){n.addComment(e,o.postId,t.replyToCommentId).then(function(o){o&&(t.getPost(),t.getAllComments(),t.replyToPost=!0,t.replyToCommentId=void 0,t.newComment="")})},t.deleteComment=function(o){n.deleteComment(o).then(function(o){o&&t.getAllComments()})},t.getTabPosts=function(){n.getRandomPosts(4).then(function(o){t.tabPosts=[e.recentPosts.slice(0,-1),e.popularPosts.slice(0,-1),o]})},t.toggleTab=function(o){t.tabPostsShow=new Array(3),t.tabPostsShow[o]=!0},t.getPost=function(){n.getPost(o.postId).then(function(s){e.title=s.title,t.post=s,t.getAllComments(),n.getRelatedPosts(o.postId,t.post.tags,5).then(function(o){t.relatedPosts=o})})},t.getPost(),t.getTabPosts()})}();
!function(){"use strict";newsApp.controller("PostsController",function(e,t,o,r,n,a){e.itemsPerPage=a,e.isUser=!1,e.isPost=!0,e.pages=5,e.getPage=function(s){e.currentPage=s?s:e.currentPage;var c=(s-1)*a,i=t.categoryName;i?(i=i.replace(/_/g," "),e.isHome=!0):e.isHome=!1;var u=function(){var e;return i&&$.each(n,function(t){return t.toLowerCase()===i.toLowerCase()?(e=t,!1):void $.each(n[t],function(o){var r=n[t][o];return r.toLowerCase()===i.toLowerCase()?(e=r,!1):void 0})}),e};i=u(),r.getCategory(c,a,i).then(function(t){e.collection=t.posts,e.totalItems=t.count,i&&(o.title=i)})},e.getPage(1)})}();
...
!function(){"use strict";newsApp.controller("SearchController",function(e,t,n,r){e.itemsPerPage=r,e.isPost=!0,e.isUser=!1,e.pages=5,e.getPage=function(o){e.currentPage=o?o:e.currentPage;var c=(e.currentPage-1)*r;n.search(c,r,t.word).then(function(t){e.collection=t.posts,e.totalItems=t.count}),e.isHome=!0},e.getPage(1)})}();
!function(){"use strict";newsApp.controller("TagsController",function(t,e,n,g,o){n.title="Tag "+e.tag,t.itemsPerPage=o,t.isPost=!0,t.isUser=!1,t.pages=5,t.getPage=function(n){t.currentPage=n?n:t.currentPage;var a=(t.currentPage-1)*o;g.getByTag(a,o,e.tag).then(function(e){t.collection=e.posts,t.totalItems=e.count}),t.isHome=!0},t.getPage(1)})}();
...
!function(){"use strict";newsApp.controller("UsersController",function(e,t,n){e.itemsPerPage=n,e.isPost=!1,e.isUser=!0,e.pages=5,e.getPage=function(r){e.currentPage=r?r:e.currentPage;var s=(e.currentPage-1)*n;t.getUsers(s,n).then(function(t){e.collection=t.users,e.totalItems=t.count}),e.isHome=!0},e.getPage(1)})}();
